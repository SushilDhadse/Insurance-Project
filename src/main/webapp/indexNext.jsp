...
#grad1 {
  height: 55px;
  background-color: lightgreen; /* Standard syntax (must be last) */
}
...
<body>
  	...
  	<h2 align="left">KARS Insure<i style='float:right'> ${sessionScope.user.firstName }&nbsp;<i class='fas fa-user-circle' style='font-size:36px;float:right'>&nbsp;</i></i>&nbsp;&nbsp;</h2>
        </div> 
