...
<head>
<H4 align="center">
	<b><strong>Estimate Vehicle Insurance</strong></b>
</H4>
...
<body>
	<form action="controller/listBikeController" method="post">
<style>
	...
	align: center;
		...
		<div>
			<form>
				<table align="center">
					<tr>
						<td>Two Wheeler Insurance Calculator</td>
					</tr>
					<tr>
						<td>Enter Bike Model Name :</td>
						<td>
								<select id="bikeName" name="bikeName"  required>
								<option value="">Select Bike Name</option>
										<c:forEach items="${ listOfBikes }"  var="bike">
	  											<option value="${ bike.bikePrice }">${ bike.bikeName }</option>
										</c:forEach>
								</select>
						</td>
					</tr>
					<tr>
						<td>Enter Bike's Age :</td>
						<td><select id="manufactureyear" name="bikeAge" required>
    							<option value="">Select Bike Age</option>
					...
					<tr>
						<td colspan="2"><input type="button" value="Calculate Premium"
							id="bPremium" onclick="calculate()"></td>
					</tr>
					<tr>
						<td>Basic Details : <br>
						</td>
					...
					<tr>
						<td>Year :</td>
						<td><input type="text" id="year" placeholder="Year"
							readonly></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="number" id="final-premium"
							placeholder="Final Premium" readonly style="background-color: #a6a6a6; font-weight: bold;"></td>
					</tr>
				</table>
				<script>
					var idv;
					...
					function calculate() {
						if(document.getElementById("manufactureyear").value == 10){
							bikeprice = document.getElementById("bikeName").value;
							idv =bikeprice-(bikeprice * (10 / 100));
							year ="1 Year";
							document.getElementById("year").value = year;
						}
						if(document.getElementById("manufactureyear").value == 20){
							bikeprice = document.getElementById("bikeName").value;
							idv = bikeprice-(bikeprice * (20 / 100));
							year ="2 Year";
							document.getElementById("year").value = year;
						}
						if(document.getElementById("manufactureyear").value == 30){
							carprice = document.getElementById("bikeName").value;
							idv = bikeprice-(bikeprice * (30 / 100));
							year ="3 Year";
							document.getElementById("year").value = year;
						}
