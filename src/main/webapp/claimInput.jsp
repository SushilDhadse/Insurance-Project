...
<body>
	...
	<form align="center" name="claimForm"
		...
		<div class="container">
			...
			<br> Policy Number : <br> <input type="number" name="policyNumber"
				class="form-control text" placeholder="Policy Number" >


			<br>Mobile Number: <br> <input type="number" name="contactNumber"
				class="form-control text" placeholder=" Mobile Number "><br>
				
				<br>Select Reason: <br>
      <select name="reason" class="form-control text" > 
